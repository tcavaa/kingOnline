...
export const ACHIEVEMENT_DEFS = {
  ...
  PERFECT_PLUS:           { Icon: Star,          color: '#f0c75a', label: 'Perfect Plus',       desc: '10/10 tricks in a Plus round',                        repeatable: true  },
  PLUS_PERFECTIONIST:     { Icon: Gem,           color: '#38bdf8', label: 'Plus Perfectionist', desc: '10/10 in all 3 Plus rounds in one game',              repeatable: true  },
  UNTOUCHABLE:            { Icon: Shield,        color: '#a3d68a', label: 'Untouchable',        desc: 'Led every negative round without taking any penalty', repeatable: true  },
  NEVER_BELOW_ZERO:       { Icon: TrendingUp,    color: '#4ade80', label: 'In the Green',       desc: 'Score never dropped below zero',                      repeatable: true  },
  UNDERDOG:               { Icon: Flame,         color: '#fb923c', label: 'Underdog',           desc: 'Won despite being in last place the longest',         repeatable: true  },
  RUNAWAY_WIN:            { Icon: Rocket,        color: '#f472b6', label: 'Runaway',            desc: 'Won with 100+ point margin over 2nd place',           repeatable: true  },

  // ── Lifetime milestones (earned once) ─────────────────────────────────────
  PERFECT_PLUS_HAT_TRICK: { Icon: Sparkles,      color: '#fbbf24', label: 'Hat Trick Plus',     desc: '10/10 in a Plus round 3+ times (lifetime)',           repeatable: false },
  GAMES_50:               { Icon: Gamepad2,      color: '#cbd5e1', label: 'Dedicated',          desc: 'Played 50 games',                                     repeatable: false },
  GAMES_100:              { Icon: Joystick,      color: '#cbd5e1', label: 'Century',            desc: 'Played 100 games',                                    repeatable: false },
  GAMES_150:              { Icon: Crown,         color: '#f0c75a', label: 'Legend',             desc: 'Played 150 games',                                    repeatable: false },
  GAMES_250:              { Icon: Sparkle,       color: '#c4b5fd', label: 'Veteran',            desc: 'Played 250 games',                                    repeatable: false },
  GAMES_500:              { Icon: Sun,           color: '#facc15', label: 'Elite',              desc: 'Played 500 games',                                    repeatable: false },
  GAMES_800:              { Icon: Medal,         color: '#fcd34d', label: 'Master',             desc: 'Played 800 games',                                    repeatable: false },
  GAMES_1000:             { Icon: Gem,           color: '#67e8f9', label: 'Grandmaster',        desc: 'Played 1000 games',                                   repeatable: false },
  WINS_10:                { Icon: Medal,         color: '#cd7f32', label: '10 Wins',            desc: 'Won 10 games',                                        repeatable: false },
  WINS_25:                { Icon: Medal,         color: '#cbd5e1', label: '25 Wins',            desc: 'Won 25 games',                                        repeatable: false },
  WINS_50:                { Icon: Medal,         color: '#f0c75a', label: '50 Wins',            desc: 'Won 50 games',                                        repeatable: false },
  WINS_250:               { Icon: Trophy,        color: '#f0a500', label: '250 Wins',           desc: 'Won 250 games',                                       repeatable: false },
  WINS_500:               { Icon: Skull,         color: '#f87171', label: '500 Wins',           desc: 'Won 500 games',                                       repeatable: false },
  WINS_1000:              { Icon: Swords,        color: '#ef4444', label: '1000 Wins',          desc: 'Won 1000 games',                                      repeatable: false },
  WIN_STREAK_3:           { Icon: Zap,           color: '#fde047', label: '3 in a Row',         desc: 'Won 3 consecutive games',                             repeatable: false },
  WIN_STREAK_5:           { Icon: CloudLightning,color: '#a3e635', label: '5 in a Row',         desc: 'Won 5 consecutive games',                             repeatable: false },
  WIN_STREAK_10:          { Icon: Award,         color: '#f0a500', label: '10 in a Row',        desc: 'Won 10 consecutive games',                            repeatable: false },
}
